...
**Tag:** `runtime-2026-07-19` (annotated; `git rev-parse runtime-2026-07-19^{}`)  
...
| HEAD | tag tip (reliability docs) / runtime `b663563635…` | `4a322dcd084a1a3dc1032fe8511896bc3e7a21e0` |
