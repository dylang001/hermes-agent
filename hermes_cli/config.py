...
DEFAULT_CONFIG = {
    ...
    "compression": {
        ...
        # Production continuity-first defaults; interactive profile may raise
        # via context_governor. Models with context windows below 512K are
        # floored at 0.75 (raise-only).
        "threshold": 0.70,
