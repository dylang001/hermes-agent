...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- Weather/forecast requests → if the location is known from the request or "
    "session context, use web_search; if no location is available, ask for the "
    "location in one short question instead of inventing a forecast or listing "
    "generic ways to check it.\n"
