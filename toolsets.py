...
_HERMES_CORE_TOOLS = [
    ...
    # Context Engineering V2 archive retrieve (gated on
    # context_engineering_v2.retrieve.enabled via check_fn)
    "context_archive",
...
TOOLSETS = {
    ...
    "context_archive": {
        "description": (
            "Retrieve archived SAFE tool dumps (Context Engineering V2 Layer 5). "
            "Gated on context_engineering_v2.retrieve.enabled"
        ),
        "tools": ["context_archive"],
        "includes": [],
    },
