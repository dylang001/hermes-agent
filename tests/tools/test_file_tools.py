...
class TestWriteFileHandler:
    ...
    def test_writes_content(self, mock_get):
        import os as _os
        expected_path = _os.path.realpath("/tmp/out.txt")
        mock_ops = MagicMock()
        result_obj = MagicMock()
...
class TestPatchHandler:
    ...
    def test_replace_mode_calls_patch_replace(self, mock_get):
        import os as _os
        expected_path = _os.path.realpath("/tmp/f.py")
        mock_ops = MagicMock()
        result_obj = MagicMock()
    ...
    def test_replace_mode_replace_all_flag(self, mock_get):
        ...
        mock_ops.patch_replace.assert_called_once_with(expected_path, "x", "y", True)
